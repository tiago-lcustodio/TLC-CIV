...
class Jogador:
    def __init__(self, jogador_id, nome, cor, civilizacao, humano=True, dificuldade='Padrão', uid=None):
        self.id = jogador_id  # índice curto mantido por compatibilidade do motor
        ...
        # Recursos globais: pertencem à civilização, não a uma cidade isolada.
        self.ouro = 0
        self.ciencia = 0
        self.fe = 0

        # A fonte de verdade da capital passa a ser o jogador.
        self.capital_id = None

        # Estrutura para efeitos temporários de tecnologia, evento, religião etc.
